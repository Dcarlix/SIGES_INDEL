            ...
            modelBuilder.Entity("SIGES_INDEL.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasIndex("DocenteId1")
                        .IsUnique()
                        .HasFilter("[DocenteId1] IS NOT NULL");
            ...
            modelBuilder.Entity("SIGES_INDEL.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("SIGES_INDEL.Models.Docente", null)
                        .WithOne("User")
                        .HasForeignKey("SIGES_INDEL.Models.ApplicationUser", "DocenteId1");
